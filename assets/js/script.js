...
$('#rsvp-form').on('submit', function (e) {
    ...
    $('#alert-wrapper').html(alert_markup('info', 'Saving your details...'));

    $.post('https://script.google.com/macros/s/AKfycbwKCdL9Eun7Z4mezfNUEFba9FpwY4eYi9IxEKb7cQqRxGoZvFiWwcxPk3QgEKdlozef/exec', data)
            .done(function (data) {
                console.log(data);
                if (data.result === "error") {
                    $('#alert-wrapper').html(alert_markup('danger', data.message));
                } else {
                    $('#alert-wrapper').html(alert_markup('info', 'Thank you for joining us!'));
                }
            })
            .fail(function (data) {
                console.log(data);
